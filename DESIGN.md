...
Search inputs use an 11px radius, visible focus ring, and a 44px minimum height. Code blocks use 12px radius, restrained contrast, and horizontal scrolling.
